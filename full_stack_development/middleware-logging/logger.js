/**
 * Universal Logger to POST logs to Evaluation API
 * Works in Node.js and Browser
 * - Authenticates and caches token as needed
 * - Exposed function: Log(stack, level, pkg, message)
 * - Usage: import { Log } from "../middleware-logging/logger";
 */

// ----------------------- CONFIG ------------------------
// Put your details here or inject via args/env for prod build
